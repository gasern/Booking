...
(function () {
    ...
    datePicker.languageinfo = datePicker.languageinfo ? datePicker.languageinfo.toLowerCase().replace(/-[a-z]+$/, "") : 'da';
...
/*@end
    ...
    datePicker.months = ["Januar", "Februar", "Marts", "April", "Maj", "Juni", "Juli", "August", "September", "Oktober", "November", "December"];
    datePicker.fullDay = ["Mandag", "Tirsdag", "Onsdag", "Torsdag", "Fredag", "Lørdag", "Søndag"];
    datePicker.titles = ["Forrige måned", "Næste måned", "Forrige år", "Næste år", "Idag", "Vis Kalender"];
